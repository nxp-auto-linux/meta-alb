...
SRC_URI = " git://source.codeaurora.org/external/autobsps32/gpu;branch=alb/master;protocol=https \
           ${FSL_LOCAL_MIRROR}/Vivante_userspace_libraries_and_demos/gpu-viv-bin-s32v234-6.2.4.p2-hardfp.run;fsl-eula=true \
          "
...
do_compile_prepend() {
    export VIVANTE_USERSPACE="${WORKDIR}/gpu-viv-bin-s32v234-6.2.4.p2-hardfp"
