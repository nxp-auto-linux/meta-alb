...
SRCREV = "10d91620420487450bf8d7d140abaaa1690d21cc"
...
SRC_URI_append_s32v2xx = " ${@base_conditional('KERNEL_FEC_LIMIT_TX', '0', '', ' file://0001-fec-limit-TX-queues-to-prevent-TX-starvation-crash.patch', d)}"
