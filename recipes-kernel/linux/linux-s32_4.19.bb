...
SRC_URI = "git://source.codeaurora.org/external/autobsps32/linux;protocol=https;branch=hotfix/bsp24.0.hf1"
SRCREV = "7c931129efaeca97bde33010099ac6c7e2e8212d"
...
DELTA_KERNEL_DEFCONFIG_append_s32g274aevb += "${@bb.utils.contains('DISTRO_FEATURES', 'xen', 'xen_watchdog.cfg', '', d)}"
DELTA_KERNEL_DEFCONFIG_append_s32g274ardb += "${@bb.utils.contains('DISTRO_FEATURES', 'xen', 'xen_watchdog.cfg', '', d)}"
DELTA_KERNEL_DEFCONFIG_append += "${@bb.utils.contains('DISTRO_FEATURES', 'xen', 'xen.cfg', '', d)}"
SRC_URI_append_s32g274aevb = "${@bb.utils.contains('DISTRO_FEATURES', 'xen', 'file://build/xen_watchdog.cfg', '', d)} "
